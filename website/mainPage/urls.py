...
app_name = "mainPage"
urlpatterns = [
    path('schedulepage/', views.index, name = 'schedule'), #schedulepage/, the 'home page', view of the schedule
    ...
    path('calendarpage/year/<int:year>', views.yearview, name = 'yearview'),
